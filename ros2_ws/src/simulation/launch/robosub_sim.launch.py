...
from launch.actions import (  # noqa: F401
    DeclareLaunchArgument,
    GroupAction,
    IncludeLaunchDescription,
    TimerAction,
)
from launch.substitutions import (  # noqa: F401
    Command,
    LaunchConfiguration,
            ...
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    "simulation_data": PathJoinSubstitution(
                        [FindPackageShare("simulation"), "data"]
                    ),
                    "scenario_desc": PathJoinSubstitution(
                        [FindPackageShare("simulation"), "scenarios", "test_pool.scn"]
                    ),
